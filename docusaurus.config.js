...
*/
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                href: "https://github.com/IBM/repo-template/blob/main/CODE_OF_CONDUCT.md",
              },
            ],
          },
          {
            ...
            items: [
              ...
              {
                html: `
                <a href="https://github.com/ibm/" target="_blank" rel="noreferrer noopener" aria-label="GitHub Icon">
          ...
          },
          {
            ...
            items: [
              {
                html: `
                <a href="https://linkedin.com/company/ibm" target="_blank" rel="noreferrer noopener" aria-label="LinkedIn Icon">
                  <img
                    class="linkedin"
              ...
              {
                html: `
                <a href="https://www.reddit.com/r/ibm/" target="_blank" rel="noreferrer noopener" aria-label="Reddit Icon">
                  <img class="reddit"
        ...
        copyright: `Copyright © ${new Date().getFullYear()} IBM, Inc. Built with Docusaurus.`,
      },
      prism: {
